...
The effectiveness of the \gls{gaap} method is tested for different combination of the weight size and the size of the \gls{psf}. The measured flux values are compared to the true flux values, where the weight function is centered at the middle of the image, i.e., the galaxy.
