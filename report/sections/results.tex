...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\linewidth]{results/figures/simulation/error_weight_psf_size.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{results/figures/observation/snr_comparison.pdf}
