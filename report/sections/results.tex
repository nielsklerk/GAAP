...
\begin{figure}[H]
    ...
    \caption{Color color diagram of the stars in the field 53.00 -28.00. The colors are derived from the flux in the DECam filters G, R, I. The sources in the image are the sources that have a point-source-probability > 90\%.}
...
\begin{figure}[H]
    ...
    \caption{Color color diagram of the stars in the field 53.00 -28.00. The colors are derived from the flux in the Rubin filters g, r, i. The sources in the image are the sources that have a point-source-probability > 90\%.}
...
\begin{figure}[H]
    ...
    \caption{Comparison flux measurements using GAAP and that of the MER catalog for all filters in the catalog. The dashed line denote equal SNR.}
    \label{fig:placeholder}
\end{figure}
