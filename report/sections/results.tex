...
\begin{figure}[H]
    ...
    \caption{Comparison of \gls{snr} from \gls{pca-phot} and the \gls{mer} catalog for all catalog filters. The dashed line denotes equal \gls{snr}. The measurements are from tiles \textbf{TILEINDEX} (top row), \textbf{TILEINDEX} (middle row), and \textbf{TILEINDEX} (bottom row).}
