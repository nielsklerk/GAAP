...
\section{Flux Measurement}\label{subsec: flux measurement}
...
\end{equation}
This equation forms the basis for the \gls{x-bap} method. 
...
\newpage
\section{Noise Estimation from Background Noise}\label{subsec: Noise Estimation from background Noise}
...
\newpage
\section{Noise from RMS Map}\label{subsec: Noise from RMS}
