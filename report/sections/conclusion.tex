...
\begin{itemize}
    ...
    \item Three tiles deviated from the fluxes measured in other tiles. These tiles have tile indices: 102021578, 102021579, and 102021579. The reason for the difference is the $z$ band, where the measured aperture flux deviates strongly from the aperture fluxes in other tiles. \textbf{REASON}
\end{itemize}
